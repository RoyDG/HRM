		...
		<div class="oe_form_sheetbg">
          ...
          <? 	 
			$res = 'SELECT p.PROMOTION_D_ID,
        			...
        			JOIN personnel_basic_info a ON p.PROMOTION_REPORTING_AUTH = a.PBI_ID
        			JOIN designation d1 ON p.PROMOTION_PRESENT_DESG = d1.DESG_ID
        			JOIN designation d2 ON p.PROMOTION_PAST_DESG = d2.DESG_ID
        			WHERE p.PBI_ID = ' . $_SESSION['employee_selected'];
