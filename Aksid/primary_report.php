...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  ...
  <thead>
	...
	<tr><td colspan="11" style="text-align: center;border:0px solid white; font-size:15px;"><strong>Bank Advice </strong></td></tr>

	<tr>

      <td style="border:0px;" colspan="28"><div align="center" style="font-size:20px;">Allowances Sheet for the Period of
...
echo date("M-Y", $d) . ""; ?>
          ...
          <? $test = new DateTime('01-'.$_POST['mon'].'-'.$_POST['year'].' '); echo date_format($test, 'M-Y').'<br>'.$depts;  ?>
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  ...
  <thead>
	...
	<tr><td colspan="11" style="text-align: center;border:0px solid white; font-size:15px;"><strong> </strong></td></tr>
...
echo date("M-Y", $d) . ""; ?>
	...
	<th><div align="center">Name</div></th>
      ...
      <th><div align="center">Wallet No</div></th>



      <th><div align="center">Pay Amount</div></th>

      <th><div align="center">Remarks/Narration</div></th>
...
?>
	...
	<td><div align="center"><?=$data2->PBI_NAME?></div></td>
      ...
      <td><div align="right"><?=$data2->amount?></div></td>

      <td><div align="center"><?=$data2->remarks?></div></td>
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  ...
  <tr>
      ...
      <td style="border:0px;" colspan="28"><div align="center" style="font-size:20px;">Staff Incentive Advice Sheet for the Period of
...
<!--  ******************************    Tax report Start HERE    ****************************-->
  ...
  <thead><tr><td style="border:0px;" colspan="28"><?=$str?></td></tr>

   <tr><td style="border:0px;" colspan="28"><div align="center" style="font-size:20px;">Statement of Tax Deducted from Salaries  For the month of
   ...
   <?=$month_name?>-<?=$_POST['year']?></div></td></tr>
   ...
   <td style="border-left:0px; border-right:0px;" colspan="28"><div align="center" style="font-size:20px;">under section 50 of the Income Tax Ordiance, 1984 (XXXVI of 1984)</div></td>
      ...
      <td colspan="4"><div align="center">Payment of deducted tax to the credit of the Government</div></td>
    ...
    <tr>
       ...
       <th rowspan="2"><div align="center">Festival Bonus</div></th>
		...
		<th rowspan="2"><div align="center">Cumulative deduction in this month of current year</div></th> <!-- calculatig current finacial year tax amount ex: if select year 2021 and mon nov then report will be jul 2021 to nov 2021 tax amount   -->
...
$tr_con .= ' and s.year="'.$_POST['year'].'"';*/
		...
		where  i.income_tax>0  and  p.PBI_ID=i.PBI_ID and p.PBI_JOB_STATUS = "In Service"  and i.year in ("'.$_POST['year'].'","'.$next_year.'") '.$tr_con.' group by i.PBI_ID order by i.income_tax desc ';
...
//for dynamic month and year
   ...
   ?>
       ...
       <tr>
        ...
        <td align="right"><?=($bank_amt>0)? number_format($basic_bank=$bank_amt/100*50) : '';      $totBasic += $basic_bank?></td>



        <td align="right"><?=($bank_amt>0)? number_format($house_bank=$bank_amt/100*25) : '';      $totHouse += $house_bank?></td>



        <td align="right"><?=($bank_amt>0)? number_format($medical_bank=$bank_amt/100*15) : '';      $totMedical += $medical_bank?></td>



        <td align="right"><?=($bank_amt>0)? number_format($allowance_bank=$bank_amt/100*10) : '';      $totspecial += $allowance_bank?></td>
        ...
        <td align="right"><?=($basic_salary>0)? number_format($basic_salary) : '';              $totBasic +=$basic_salary?></td>

        <td align="right"><?=($house_rent>0)? number_format($house_rent) : '';                  $totHouse +=$house_rent?></td>

        <td align="right"><?=($medical_allowance>0)? number_format($medical_allowance) : '';    $totMedical +=$medical_allowance?></td>

        <td align="right"><?=($special_allowance>0)? number_format($special_allowance) : '';    $totspecial +=$special_allowance?></td>
...
<?
	  ...
	  <td><div align="center"><strong><?=number_format($totBasic,0)?> </strong></div></td>



	  <td><div align="center"><strong><?=number_format($totHouse,0)?></strong></div></td>



	  <td><div align="center"><strong><?=number_format($totMedical,0)?></strong></div></td>



	  <td><div align="center"><strong><?=number_format($totspecial,0)?></strong></div></td>



    <td><div align="center"><strong><?=number_format($fastivelsum,0)?></strong></div></td>
    ...
    <td><div align="center"><strong><?=number_format($sum_total_amount_of_salary,0)?></strong></div></td>



	  <td><div align="center"><strong><?=number_format($sum_of_tax_deduct,0)?></strong></div></td>
	  ...
	  <td><div align="center"><strong><?=number_format($sum_total_tax_deduct,0)?> </strong></div></td>
...
<!--  ******************************    Tax report Start HERE    ****************************-->
  ...
  <thead><tr><td style="border:0px;" colspan="28"><?=$str?></td></tr>
   ...
   <tr><td style="border:0px;" colspan="28"><div align="center" style="font-size:20px;">Monthly withholding Tax & VAT Calculation
   ...
   <td style="border-left:0px; border-right:0px;" colspan="28"><div align="center" style="font-size:20px;"></div></td>
    ...
    <tr>
       ...
       <th rowspan="2"><div align="center">SL </div></th>
        ...
        <th rowspan="2"><div align="center">Supplier's Name</div></th>



        <th rowspan="2"><div align="center">Supplier's Address.</div></th>



        <th rowspan="2"><div align="center">Expense/Cost Head As Per F/S</div></th>

        

		<th rowspan="2"><div align="center"> Value Paid</div></th>
		...
		<th rowspan="2"><div align="center">Deducted VAT</div></th>



		<th rowspan="2"><div align="center">VDS Code</div></th>



       <th rowspan="2"><div align="center">Base Amount for TDS</div></th>





		<th rowspan="2"><div align="center">Deducted TDS</div></th>



		<th rowspan="2"><div align="center">TDS Section</div></th>



		<th rowspan="2"><div align="center">VDS Rate</div></th>

		

        <th rowspan="2"><div align="center">TDS Rate</div></th>



		<th rowspan="2"><div align="center"> Date of Deduction </div></th>



		<th rowspan="2"><div align="center">Date of Posting/Transaction</div></th>



		<th rowspan="2"><div align="center">Voucher No.</div></th>



		<th rowspan="2"><div align="center">Type of Voucher</div></th>



		<th rowspan="2"><div align="center">Cost Head/Ledger Head</div></th>



		<th rowspan="2"><div align="center">Cost Center</div></th>



		<th rowspan="2"><div align="center">Sub CC 1</div></th>
   ...
   ?>
       ...
       <tr>
        ...
        <td align="right">S037.00</td>
         ...
         <td align="right"><?=($vat>0)? number_format($base_amt_for_tds = $value_paid-$vat) : ''; $base_for_tds = $value_paid-$vat?></td>
...
$totTax = $totTax+$tax_paid;
	  ...
	  <td><div align="center"><strong><?=number_format($tot_value_paid,0)?> </strong></div></td>



	  <td><div align="center"><strong><?=number_format($tot_vat,0)?></strong></div></td>
	  ...
	  <td><div align="center"><strong><?=number_format($totTase_amt_for_tds,0)?></strong></div></td>



    <td><div align="center"><strong><?=number_format($totTax,0)?></strong></div></td>



	  <td colspan="11"><div align="center"><strong></strong></div></td>
...
echo date("M-Y", $d) . ""; ?>
    ...
    <tr>
      ...
      <th colspan="9"><div align="center">Allowances</div></th>

      <th rowspan="2"><div align="center">Total Allowances</div></th>

      <th rowspan="2"><div align="center">Bank A/C</div></th>

      <th rowspan="2"><div align="center">Payroll Card</div></th>
    ...
    <tr>
      ...
      <th><div align="center">Site Visit</div></th>

      <th><div align="center">Health</div></th>

      <th><div align="center">Fuel</div></th>

	  <th><div align="center">Overtime</div></th>

	  <th><div align="center">Ifter</div></th>
...
?>
    ...
    <tr>
      ...
      <td><div align="right"><?=($conData->food_bill>0)? number_format($conData->food_bill) : '';  $totFod += $conData->food_bill?></div></td>

      <td><div align="right"><?=($conData->conveyance>0)? number_format($conData->conveyance) : '';  $totCon += $conData->conveyance?></div></td>

      <td><div align="right">

          <?=($conData->site_visit>0)? number_format($conData->site_visit) : '';  $totSite += $conData->site_visit?>

        </div></td>

      <td><div align="right">

          <?=($conData->health>0)? number_format($conData->health) : '';  $totHealth += $conData->health?>

        </div></td>

      <td><div align="right">

          <?=($conData->fule>0)? number_format($conData->fule) : '';  $totFule += $conData->fule?>
		...
		<td><div align="right">
          ...
          <?=($conData->overtime>0)? number_format($conData->overtime) : '';  $totOvertime += $conData->overtime?>
		...
		<td><div align="right">
          ...
          <?=($conData->ifter>0)? number_format($conData->ifter) : '';  $totIfter += $conData->ifter?>
		...
		<td><div align="right">
          ...
          <?=($conData->hotel>0)? number_format($conData->hotel) : '';  $totHotel += $conData->hotel?>
		...
		<td><div align="right">
          ...
          <?=($conData->others>0)? number_format($conData->others) : '';  $totOthers += $conData->others?>
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  ...
  <thead>
    ...
    <tr>
      ...
      <td style="border:0px;" colspan="28"><div align="center" style="font-size:20px;">Staff Incentive disbursement in the month of
	  ...
	  <?
	      ...
	      //$month_name=find_a_field('monthly_sales_commission','mon','year='.$next_year);



		 //$com_data=find_all_field('monthly_sales_commission','',"year=".$_POST['year'].'" and mon="'.$_POST['mon'].'"');
		 ...
		 $next_year  = $_POST['dispatched_year']+1;
	      ...
	      //$test = new DateTime('01-'.$month_name.'-'.$next_year);

		  $test = new DateTime('01-'.$_POST['mon'].'-'.$_POST['year'].' ');

		  echo date_format($test, 'M-Y');?>

          <? //$d=strtotime("-1 Months"); echo date("M-Y", $d) . ""; ?>
    ...
    <tr>
      ...
      <th colspan="12"><div align="center">Incentive Period</div></th>

	  <th rowspan="2"><div align="center">Special Consideration</div></th>

      <th rowspan="2"><div align="center">Total Incentive</div></th>

      <th rowspan="2"><div align="center">Tax Deduction</div></th>

      <th rowspan="2"><div align="center">Advance deduction</div></th>

      <th rowspan="2"><div align="center">Net payment</div></th>
    ...
    <tr>
	  ...
	  <th><div align="center"><?='Jul-'.$fin_start_year;?></div></th>

	  <th><div align="center"><?='Aug-'.$fin_start_year;?></div></th>

	  <th><div align="center"><?='Sep-'.$fin_start_year;?></div></th>

	  <th><div align="center"><?='Oct-'.$fin_start_year;?></div></th>

	  <th><div align="center"><?='Nov-'.$fin_start_year;?></div></th>

	  <th><div align="center"><?='Dec-'.$fin_start_year;?></div></th>



      <th><div align="center"><?='Jan-'.$next_year;?> </div></th>

      <th><div align="center"><?='Feb-'.$next_year;?></div></th>

      <th><div align="center"><?='Mar-'.$next_year;?></div></th>

      <th><div align="center"><?='Apr-'.$next_year;?></div></th>

      <th><div align="center"><?='May-'.$next_year;?></div></th>

	  <th><div align="center"><?='Jun-'.$next_year;?></div></th>
    ...
    <tr>
      ...
      <?php /*?><td><div align=""><?=$conData->DEPT_DESC?></div></td><?php */?>
	    ...
	    <td><div align="right">
          ...
          <?=($conData->jul_com>0)? number_format($conData->jul_com) : '';  $tot_jul_com += $conData->jul_com?>
		...
		<td><div align="right">
          ...
          <?=($conData->aug_com>0)? number_format($conData->aug_com) : '';  $tot_aug_com += $conData->aug_com?>
		...
		<td><div align="right">
          ...
          <?=($conData->sep_com>0)? number_format($conData->sep_com) : '';  $tot_sep_com += $conData->sep_com?>
		...
		<td><div align="right">
          ...
          <?=($conData->oct_com>0)? number_format($conData->oct_com) : '';  $tot_oct_com += $conData->oct_com?>
		...
		<td><div align="right">
          ...
          <?=($conData->nov_com>0)? number_format($conData->nov_com) : '';  $tot_nov_com += $conData->nov_com?>
		...
		<td><div align="right">
          ...
          <?=($conData->dec_com>0)? number_format($conData->dec_com) : '';  $tot_dec_com += $conData->dec_com?>
      ...
      <td><div align="right"><?=($conData->jan_com>0)? number_format($conData->jan_com) : '';  $tot_jan_com+= $conData->jan_com?></div></td>

      <td><div align="right"><?=($conData->feb_com>0)? number_format($conData->feb_com) : '';  $tot_feb_com += $conData->feb_com?></div></td>

      <td><div align="right">

          <?=($conData->mar_com>0)? number_format($conData->mar_com) : '';  $tot_mar_com += $conData->mar_com?>

        </div></td>

      <td><div align="right">

          <?=($conData->apr_com>0)? number_format($conData->apr_com) : '';  $tot_apr_com += $conData->apr_com?>

        </div></td>

      <td><div align="right">

          <?=($conData->may_com>0)? number_format($conData->may_com) : '';  $tot_may_com += $conData->may_com?>
		...
		<td><div align="right">
          ...
          <?=($conData->jun_com>0)? number_format($conData->jun_com) : '';  $tot_jun_com += $conData->jun_com?>
		...
		<td><div align="right">
          ...
          <?=($conData->special_consideration>0)? number_format($conData->special_consideration) : '';  $tot_special_consideration += $conData->special_consideration?>
      ...
      <td><div align="right">
          ...
          <?=($conData->tax_deduction>0)? number_format($conData->tax_deduction) : '';  $tot_tax_deduction += $conData->tax_deduction?>

        </div></td>

      <td><div align="right">

          <?=($conData->advance_deduction>0)? number_format($conData->advance_deduction) : '';  $tot_adv_deduction += $conData->advance_deduction?>
...
<td style="text-align:right;width:20%;"><?=number_format($last_month_earning_proj,0)?></td>
 ...
 <?=(number_format($this_month_earning_proj)>0)? number_format($this_month_earning_proj):''; $all_proj_salary_earning =$all_proj_salary_earning + $this_month_earning_proj;?>

<input type="hidden" name="salary_amount[]" value="<?=$this_month_earning_proj?>" /></td>
...
<td style="text-align:right;width:20%;"><?=$total_project_emp; $total_no_emp_pro +=$total_project_emp;?></td>
...
<?=(number_format($this_month_earning_dept)>0)? number_format($this_month_earning_dept):'' ; $all_dept_salary_earning = $all_dept_salary_earning + $this_month_earning_dept;?>
...
<td style="text-align:right;width:20%;"><?=$total_deparment_emp; $total_no_emp_dep +=$total_deparment_emp;?></td>
...
<tr bordercolor="#FFFFFF"><th width="100%" colspan="3" style="text-align:center">Cash Allowances</th></tr>
...
<td style="text-align:right"><?=(number_format($jl_result1->total_earning)>0)? number_format($jl_result1->total_earning):''; $all_proj_salary2_earning =$all_proj_salary2_earning + $jl_result1->total_earning;?>
...
<td style="text-align: right"><?=(number_format($jl_result->total_earning)>0)? number_format($jl_result->total_earning):''; $all_dept_salary2_earning = $all_dept_salary2_earning + $jl_result->total_earning;?>

<input name="salary_amount[]" value="<?=$jl_result->total_earning?>" type="hidden" /> </td>
...
<?=(number_format($bks_result1->total_earning)>0)? number_format($bks_result1->total_earning):''; $all_proj_bkash_earning =$all_proj_bkash_earning + $bks_result1->total_earning;?>
...
<?=(number_format($jl_result->total_earning)>0)? number_format($jl_result->total_earning):'' ; $all_dept_bkash_earning = $all_dept_bkash_earning + $jl_result->total_earning;?>
...
<?=(number_format($jl_result1->total_earning)>0)? number_format($jl_result1->total_earning):''; $all_proj_salary3_earning =$all_proj_salary3_earning + $jl_result1->total_earning;?>
...
<?=(number_format($jl_result->total_earning)>0)? number_format($jl_result->total_earning):'' ; $all_dept_salary3_earning = $all_dept_salary3_earning + $jl_result->total_earning;?>
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  ...
  <thead>
    ...
    <tr>
      ...
      <td style="border:0px;" colspan="28"><div align="center" style="font-size:20px;">Cash Allowances Sheet for the Period of
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  ...
  <thead>
    ...
    <tr>
      ...
      <td style="border:0px;" colspan="28"><div align="center" style="font-size:20px;">Bkash Allowances Sheet for the Period of
...
echo date("M-Y", $d) . ""; ?>
    ...
    <tr>
      ...
      <th rowspan="2"><div align="center">Wallet No</div></th>
