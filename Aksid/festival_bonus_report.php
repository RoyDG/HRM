...
<div id="suggesstion-box"></div>
                        ...
                        <div style="text-align:center">
                          ...
                          <tbody>
                            ...
                            <th class="oe_list_header_columns"  colspan="8" style="text-align: center!important; font-size: 19px">
                                ...
                                <td>&nbsp;</td>
                               		...
                               		<td align="center" class="alt"><input name="report" type="radio" class="radio" value="21214" /></td>
                                    <td class="alt"><strong>Bonus Summary Sheet (Bkash)</strong></td>
                                    
                                   
                                    <td align="center" class="alt"><input name="report" type="radio" class="radio" value="21214" /></td>
                                    <td class="alt"><strong>Bonus Summary Sheet (Nagad)</strong></td>
								</tr>
                                  ...
                                  <tr>
                                    ...
                                    <td class="alt"><strong>Bonus Advice (Bkash)</strong></td>
                                   
									  
                                    <td align="center" class="alt"><input name="report" type="radio" class="radio" value="21216" /></td>
                                    <td class="alt"><strong>Bonus Advice (Nagad)</strong></td>
								...
								<tr> 
                                    ...
                                    <td align="center" class="alt"><input name="report" type="radio" class="radio" value="21215" /></td>
                                    <td class="alt"><strong>Bonus Report (Bkash)</strong></td>
									 ...
									 <td align="center" class="alt"><input name="report" type="radio" class="radio" value="21215" /></td>
                                    <td class="alt"><strong>Bonus Report (Nagad)</strong></td>
