...
<div class="oe_form_sheetbg">
        ...
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <? 	
          $res = 'select id, deduction_type,payable_amt, installment_no,
          ...
          deduction_amt as total_deduction_amt  from ' . $table . ' where PBI_ID="' . $_SESSION['employee_selected'] . '" order by id desc';
