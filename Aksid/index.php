...
<head>
	...
	<style>
  .bg {
    background-image: url('hrm_mod.jpg');
  ...
  @media only screen and (min-width: 768px) {
    ...
    .bg-login {
    background-image: url('hrm_login.jpg');
    background-size: cover;
    height: 100vh;
  }
                    ...
                    <div class="details">
                        ...
                        <form action="" method="post" style="padding-top:100px">
                            ...
                            <div class="form-group">
							  ...
							  <div class="form-group">
                                <input type="text" name="uid" class="input-text" placeholder="User Name" style="color:black">
                            </div>
							
                            <div class="form-group">
                                <input type="password" name="pass" class="input-text" placeholder="Password" style="color:black">
                            </div>
                ...
                <div class="oe_login_pane oe_enterprise_pane">
                    ...
                    <form action="" method="post">
                        ...
                        <div style="opacity: 1; display: block;" class="oe_enterprise_signup">
                            ...
                            <h2><?=$project?> Warehouse Solution</h2>
