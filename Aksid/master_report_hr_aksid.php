...
if($_POST['report']==782){
?>
<table width="1800px"  id="ExportTable" cellspacing="0" cellpadding="2" border="0">
  <thead>
    <tr>
      <td style="border:0px;" colspan="6" align="left"><img src="../../img/company_logo.png" style="height:100px; width:65px;"  /></td>
      <td style="border:0px;" colspan="30"><?=$str?></td>
...
while($r = mysql_fetch_object($basic_query)){
 ...
 $last_promotion = find_all_field('promotion_detail','','PBI_ID="'.$r->PBI_ID.'" and
   PROMOTION_DATE between "'.$previous_year.'-01-1" and "'.$previous_year.'-12-31" order by PROMOTION_D_ID desc');
...
<table style="width:auto;margin:0 auto;" cellpadding="0" cellspacing="0" border="1">
  ...
  <?
	...
	echo $basic_sql='select a.PBI_ID,a.PBI_CODE,e.ESSENTIAL_JOINING_DATE,

		a.PBI_NAME ,a.PBI_DESIGNATION ,a.PBI_DEPARTMENT,a.JOB_LOCATION,
		DATEDIFF(NOW(), e.ESSENTIAL_JOINING_DATE) AS days_worked 
		
		from personnel_basic_info a,essential_info e

		where   e.PBI_ID=a.PBI_ID '.$tr_con.' group by a.PBI_ID';
