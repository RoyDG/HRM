...
<?
	...
	$jan_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=1 and pay>0 and  year="'.date("Y").'" ');
	$jan_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=1 and  year="'.date("Y").'" ');
			
	$jan_pay = $jan_salary + $jan_bonus;
			
			
			

	$feb_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=2 and pay>0 and  year="'.date("Y").'" ');
	$feb_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=2 and  year="'.date("Y").'" ');
			
	$feb_pay = $feb_salary + $feb_bonus;
			
			
			

	$mar_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=3 and pay>0 and  year="'.date("Y").'" ');
	$mar_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=3 and  year="'.date("Y").'" ');
			
	$mar_pay = $mar_salary + $mar_bonus;

	
			
	$apr_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=4 and pay>0 and  year="'.date("Y").'" ');
	
	$apr_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=4 and  year="'.date("Y").'" ');
			
	$apr_pay = $apr_salary+$apr_bonus;
			

			
			
	$may_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=5 and pay>0 and  year="'.date("Y").'" ');
	$may_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=5 and  year="'.date("Y").'" ');
			
	$may_pay = $may_salary + $may_bonus;
			

			
			
	$jun_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=6 and pay>0 and  year="'.date("Y").'" ');
			
	$jun_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=6 and  year="'.date("Y").'" ');
			
	$jun_pay = $jun_salary + $jun_bonus;
			
			
			

	$jul_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=7 and pay>0 and  year="'.date("Y").'" ');
	$jul_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=7 and  year="'.date("Y").'" ');
			
	$jul_pay = $jul_salary + $jul_bonus;
			
			
			

	$aug_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=8 and pay>0 and  year="'.date("Y").'" ');
	$aug_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=8 and  year="'.date("Y").'" ');
			
	$aug_pay = $aug_salary + $aug_bonus;
			
			
			

	$sep_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=9 and pay>0 and  year="'.date("Y").'" ');
	$sep_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=9 and  year="'.date("Y").'" ');
			
	$sep_pay = $sep_salary + $sep_bonus;
			
			
			

	$oct_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=10 and pay>0 and  year="'.date("Y").'" ');
	$oct_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=10 and  year="'.date("Y").'" ');
			
	$oct_pay = $oct_salary + $oct_bonus;
			
			
			

	$nov_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=11 and pay>0 and  year="'.date("Y").'" ');
	$nov_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=11 and  year="'.date("Y").'" ');
			
	$nov_pay = $nov_salary + $nov_bonus;
			
			
			

	$dec_salary = find_a_field('salary_attendence_lock','sum(total_earning)','mon=12 and pay>0 and  year="'.date("Y").'" ');
	$dec_bonus = find_a_field('salary_bonus_lock','sum(bonus_amt)','mon=12 and  year="'.date("Y").'" ');
			
	$dec_pay = $dec_salary + $dec_bonus;
