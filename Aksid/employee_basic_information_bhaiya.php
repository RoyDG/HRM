...
value="<?=$PBI_SERVICE_LENGTH?>" readonly="readonly">
                          ...
                          <div class="col-md-3 form-group">
                            <label class="label" for="Resign_Date">Resign Date :</label>
                            <input name="resign_date" type="text" id="resign_date" value="<?=$resign_date?>"  class="form-control"/>
                          </div>
                          <div class="col-md-3 form-group">
...
<input name="PBI_APPOINTMENT_LETTER_NO" type="text" id="PBI_APPOINTMENT_LETTER_NO" value="<?=$PBI_APPOINTMENT_LETTER_NO?>" class="form-control" />
                        ...
                        <div class="row" >
						  ...
						  <div class="col-md-2 form-group">
                            <label class="label" for="define_offday2">Define Offday 2 :</label>
