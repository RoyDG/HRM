		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				...
				<form action="" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid Company Name is required">

						<input class="input100" type="text" style="color:#000000" placeholder="Company Name" name="cid">
					...
					<!--	<a href="#" class="login100-form-social-item flex-c-m bg1 m-r-5">
						...
						<a href="log.php" target="_blank" class="login100-form-social-item flex-c-m bg2 m-r-5">
							 ...
							 <i class="fa fa-gear fa-spin" style="color:red; font-size:15px"></i> </a>
...
<button class="btn btn-default dropdown-toggle"type="button" style="background-color:#395954; width:135px; color:#FFFFFF" data-toggle="dropdown" data-hover="dropdown" data-animations="bounceInRight fadeInLeft fadeInUp fadeInRight" onClick="myfunction()">
  ...
  <?
   ...
   while($data2 = mysql_fetch_object($qr2)){
    ...
    <a href="<?php echo $data2->att_file?>" class="btn btn-warning" style="width:135px; font-size:12px; color:black;" target="_blank"><?=$data2->file_name?></a><br>
...
<div class="dropdown" style="margin-top:80px; float: left; padding-left:50px;">  
  ...
  <?
   ...
   while($data2 = mysql_fetch_object($qr2)){
    ...
    <a href="<?php echo $data2->att_file?>" class="btn btn-warning" style="width:143px; font-size:12px; color:black;" target="_blank"><?=$data2->file_name?></a><br>
...
<div class="dropdown" style="margin-top:80px; float: left; padding-left:40px">  
  ...
  <button class="btn btn-default dropdown-toggle"type="button" style="background-color:#395954; color:#FFFFFF" data-toggle="dropdown" data-hover="dropdown" data-animations="bounceInRight fadeInLeft fadeInUp fadeInRight" onClick="myfunction3()">
   ...
   <span style="padding:50px 38px 50px 38px">FORMS</span> </span>
  ...
  <?
   ...
   while($data2 = mysql_fetch_object($qr2)){
    ...
    <a href="<?php echo $data2->att_file?>" class="btn btn-warning" style="width:163px; font-size:12px; color:black;" target="_blank"><?=$data2->file_name?></a><br>
