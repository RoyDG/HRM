...
<head>
	...
	<style>
  .bg {
    background-image: url('mis_mod.jpg');
  ...
  @media only screen and (min-width: 768px) {
    ...
    .bg-login {
    background-image: url('mis_login.jpg');
    background-size: cover;
    height: 100vh;
  }
                ...
                <div class="oe_login_pane oe_enterprise_pane">
                    <form action="" method="post">
                        ...
                        <div style="opacity: 1; display: block;" class="oe_enterprise_signup">
                            <h2>J&J MIS Department</h2>
                        </div>
                        <div class="oe_login_error_message oe_enterprise_error_message"></div>

                        
                        <p>Control All synchronization, Maintain Server etc...</p>
