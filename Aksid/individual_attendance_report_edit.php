                                      ...
                                      <table width="100%" border="0" class="oe_list_content">
                                        <thead>
                                          <tr class="oe_list_header_columns">
                                            <th colspan="4">
                                              <div align="center"><span>Payroll Calculation Report </span></div>
                                            </th>
                                          </tr>
                                          <tr class="oe_list_header_columns">
                                            <th colspan="4">
                                              <div align="center"><span>Select Options</span></div>
                                            </th>
                                          </tr>
                                        </thead>
                                        <tfoot>
                                          ...
                                          <tr>
                                            ...
                                            <td align="right">
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td><input type="date" style="width: 190px;" name="start_date" id="start_date" class="form-control" required="required" value="<? if (isset($_POST['start_date'])) {
                                                                                                                                                                                    echo $_POST['start_date'];
                                                                                                                                                                                  } else {
                                                                                                                                                                                    echo date('Y-m-01');
                                                                                                                                                                                  } ?>" /></td>
                                                  <td>TO</td>
                                                  <td><input type="date" name="end_date" id="end_date" class="form-control" required="required" value="<? if (isset($_POST['end_date'])) {
                                                                                                                                                          echo $_POST['end_date'];
                                                                                                                                                        } else {
                                                                                                                                                          echo date('Y-m-25');
                                                                                                                                                        } ?>" /></td>
    ...
    <td>&nbsp;<?=$pbi->department?></td>
                                                  ...
                                                  <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <div class="row">
                                                      ...
                                                      <div class="col-4">
                                                        <tr>
                                                          <td>
                                                            <div align="center" class="cell_fonts_grant_total style7"><strong><em>Employee Code : <?php echo $_POST['PBI_CODE']; ?></em></strong></div>
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <div align="center" class="cell_fonts_grant_total style6"><strong><em>Employee Name : <?= find_a_field('personnel_basic_info', 'PBI_NAME', 'PBI_ID=' . $PBI_ID); ?> </em></strong></div>
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <div align="center" class="cell_fonts_grant_total style6"><strong><em>Designation : <?= $pbi->designation; ?> </em></strong></div>
                                                          </td>
                                                        </tr>

                                                        <tr>
                                                          <td>
                                                            <div align="center" class="cell_fonts_grant_total style6"><strong><em>Department : <?= $pbi->department; ?> </em></strong></div>
                                                          </td>
                                                        </tr>
                                                      </div>
                                            ...
                                            <tr class="oe_list_header_columns">
                                              <th colspan="4" style="text-align:center">
                                                ...
                                                <table width="100%" border="" cellspacing="0" cellpadding="0" id="grp">
                                                  <thead>
                                                    <tr bgcolor="#D6D8D9">
                                                      <th>
                                                  ...
                                                  foreach ($period as $dt) {
                                                    ...
                                                    elseif ($val[$day_date]['final_status'] == 'LATE') {
                                                      $bgcolor = '#FAF884';
                                                      $late++;
                                                      $late_min_total = $late_min_total + $val[$day_date]['final_late_min'];
                                                    ...
                                                    <td colspan="11"><br />
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                          ...
                                                          <th bgcolor="#F7E7CE">
                                                            <div align="center">PUBLIC HOLIDAYS</div>
                                                          </th>
                                                          <th bgcolor="#66CDAA">
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td align="center" bgcolor="#FFCBA4">
                                                            <div align="center"><?= $off_days; ?></div>
                                                            <div align="center"></div>
                                                          </td>
                                                          <td bgcolor="#66CDAA">
                                                            <div align="center"><?= $regular - $absent; ?></div>
                                                          </td>
                                                          <td bgcolor="#F70D1A">
                                                            <div align="center"><?= $absent ?></div>
                                                          </td>
                                                          <td bgcolor="#D1ECF1">
                                                            <div align="center"><?= $leave ?></div> <? //=$late_min_total 
                                                                                                    ?>
                                                          </td>
                                                          <td bgcolor="#9FE2BF">
                                                            <div align="center"><? //=$absent-$leave;
                                                                                ?></div>
                                                          </td>
                                                          <td bgcolor="#D5D6EA">
                                                            <div align="center"><?= $iom ?> <? //if($late_min_p>$late_day_p) echo $late_min_p*.5; else echo $late_day_p*.5;
                                                                                            ?></div>
                                                          </td>
                                                          <td bgcolor="#FFFF99">
                                                            <div align="center"> <?= $late; ?></div>
                                                          </td>
                                                          <td bgcolor="#33CCFF"> <? //$late_day_p = (int)($late/3); $late_min_p = (int)($late_min_total/30); if($late_min_p>$late_day_p) echo $late_min_p; else echo $late_day_p;
                                                                                  ?></td>
