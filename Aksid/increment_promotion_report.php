                          ...
                          <table width="100%" class="oe_list_content">
                            ...
                            <tbody>
							  ...
							  <tr >
							    ...
							    <tr >
                                <td align="center" class="alt"><input name="report" type="radio" class="radio" value="1445" /></td>
                                <td class="alt"><strong>Salary Review</strong><strong></strong></td>
                                <td align="center">&nbsp;</td>
                                <td>&nbsp;</td>
                              </tr>
							...
							<tr >
                                <td align="center" class="alt"><input name="report" type="radio" class="radio" value="1446" /></td>
                                <td class="alt"><strong> Increment new (underconstruction)</strong><strong></strong></td>
                                <td align="center">&nbsp;</td>
                                <td>&nbsp;</td>
                              </tr>
