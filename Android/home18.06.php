						...
						<div class="col-sm-12" align="center" style="padding-top:10px; padding-bottom:10px;">
							...
							<a>
								<form action="../report/master_report.php" target="_blank" method="post"> 
									<button name="report" value="2454" style="font-weight:bold; width:40%;" >View All </button>
								</form>
			...
			<div class="x_panel dp">
				...
				<tbody>
					...
					<div class="col-sm-12" align="center">
							<a href="#">
								<button style="font-weight:bold; width:40%;">
									View All 
								</button>
							</a>
					</div>
				...
				<div class="col-sm-4">
					  ...
					  <div class="container" style="border: 1px solid green; background-color: #ffff; border-radius: 5px; padding: 5px;">
						...
						<form action="../report/master_report.php" target="_blank" method="post">
						  ...
						  <a>
							<button name="report" value="1446" style="font-weight: bold; width: 40%; font-size: 8px;">View All</button>
						  </a>
						</form>
			  ...
			  <div class="container"  style="border: 1px solid green; background-color: #ffff; border-radius: 5px; padding: 5px;">
				...
				<div class="col-sm-12" align="center" style="padding-top: 10px; padding-bottom: 10px;">
					...
					<form action="../report/master_report.php" target="_blank" method="post">
						...
						<input type="hidden" name="year" value="<?= date('Y') ?>">
						  <a>
							<button name="report" value="1447" style="font-weight: bold; width: 40%; font-size: 8px;">View All</button>
						  </a>
					</form>
				...
				<div class="col-sm-4" >
					...
					<div class="container" style="border: 1px solid green; background-color: #ffff; border-radius: 5px; padding: 5px;">
						...
						<form action="../report/master_report.php" target="_blank" method="post">
						  	...
						  	<input type="hidden" name="year" value="<?= date('Y') ?>">
							  <a>
								<button name="report" value="1448" style="font-weight: bold; width: 40%; font-size: 8px;">View All</button>
							  </a>
						</form>
...
<!-- Employee By Department & Project  -->
	...
	<?php			
		...
		$sqld = "SELECT JOB_LOCATION,PBI_DEPARTMENT, count(PBI_ID) as tot_emp
		FROM personnel_basic_info 
		WHERE PBI_JOB_STATUS = 'In Service' GROUP BY PBI_DEPARTMENT , JOB_LOCATION";
		...
		while ($dataRow = mysql_fetch_object($queryd)) {
			...
			if ($dataRow->JOB_LOCATION!="") {

				$label = find_a_field('project', 'PROJECT_SHORT_NAME', 'PROJECT_ID='.$dataRow->JOB_LOCATION);

			} else {

				$label = find_a_field('department', 'DEPT_SHORT_NAME', 'DEPT_ID='.$dataRow->PBI_DEPARTMENT);
