                    ...
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                ...
                                <input type="text" name="basic_salary" id="basic-salary" class="form-control" oninput="calculateSalary()" value="<?= $basic_salary ?>" />
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                ...
                                <input name="house_rent" type="text" id="house_rent" class="form-control" value="<?= $house_rent ?>" />
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                ...
                                <input name="medical_allowance" type="text" id="medical_allowance" value="<?= $medical_allowance ?>" class="form-control" />
