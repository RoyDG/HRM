...
<table class="oe_form_group " border="0" cellpadding="0" cellspacing="0"><tbody><tr class="oe_form_group_row">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	   ...
	   <? 	 $res = 'select k.id, (select PBI_NAME from personnel_basic_info where PBI_ID=k.PBI_ID) as PA_For,(select PBI_NAME from personnel_basic_info where PBI_ID=k.LINE_MANAGER) as PA_AUTHORITY,
	   
	   d.DEPT_DESC as DEPARTMENT,(select PROJECT_DESC from project  where PROJECT_ID=p.JOB_LOCATION) as PROJECT,
	   ...
	   where k.PBI_ID=p.PBI_ID and d.DEPT_ID=p.PBI_DEPARTMENT and status="Active" order by d.DEPT_DESC,p.PBI_NAME ASC';
