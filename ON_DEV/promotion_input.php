						...
						<? foreign_relation('designation','DESG_ID','DESG_DESC',$PROMOTION_PRESENT_DESG,'1 order by DESG_DESC');?>
                                ...
                                <tr class="oe_form_group_row">
                                  ...
                                  <td class="oe_form_group_cell"><select name="PROMOTION_REPORTING_AUTH">
                                      <? foreign_relation('personnel_basic_info p, designation d','p.PBI_ID','concat(p.PBI_NAME," - ",d.DESG_DESC)',$PROMOTION_REPORTING_AUTH,'p.PBI_DESIGNATION=d.DESG_ID and p.PBI_JOB_STATUS="In Service" order by p.PBI_NAME');?>
                                    </select></td>
