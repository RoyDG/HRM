...
<div class="oe_form_sheetbg">
        ...
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <? 	$res='select d.'.$unique.', d.'.$shown.' as REFERENCE, dg.DESG_DESC as DESIGNATION, d.DEMOTION_DATE as ISSUE_DATE, d.DEMOTION_EFF_DATE as EFFECTIVE_DATE, a.PBI_NAME as REPORTING_AUTH from '.$table.' d, personnel_basic_info a, designation dg where dg.DESG_ID=d.DEMOTION_PAST_DESG and d.DEMOTION_REPORTING_AUTH=a.PBI_ID and d.PBI_ID='.$_SESSION['employee_selected'];
