...
<div class="oe_form_sheetbg">
        ...
        <div class="oe_form_sheet">
          ...
          <? 	$res='select p.'.$unique.',p.PROMOTION_REF as REFERENCE, p.PROMOTION_ISSUE_DATE as ISSUE_DATE, p.PROMOTION_DATE as EFFECTIVE_DATE, d.DESG_SHORT_NAME as NEW_DESIGNATION, a.PBI_NAME as REPORTING_AUTH from '.$table.' p, personnel_basic_info a,designation d where p.PROMOTION_REPORTING_AUTH=a.PBI_ID and p.PROMOTION_PRESENT_DESG=d.DESG_ID and p.PBI_ID='.$_SESSION['employee_selected'];
