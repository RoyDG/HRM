                              ...
                              <div class="oe_form_sheetbg">
                                ...
                                <div class="oe_form_sheet oe_form_sheet_width" style="min-height:100px;">
                                  ...
                                  <h2>
                                    ...
                                    <label for="oe-field-input-27" title="" class="oe_form_label oe_align_center"><?= $title ?></label>
                                  </h2>
                                    ...
                                    <li>
                                      ...
                                      <span class="value text-success"> <? $salary_ledger = find_a_field('personnel_basic_info', 'advance_ledger_id', 'PBI_ID="' . $_SESSION['employee_selected'] . '"');
                                                                        if ($salary_ledger > 0) {
                                                                          ...
                                                                          echo "<p class='text-danger'>Missing</p>";
                                                                        }
                                                                        ?> </span>
                                    </li>
                                    <li>
                                ...
                                <div class="oe_form_sheet oe_form_sheet_width">
                                  ...
                                  <div class="oe_view_manager_view_list">
                                    <div class="oe_list oe_view">
                                      ...
                                      <? $res = 'SELECT id,
                                      (CASE
                                      WHEN advance_type = "Advance Cash" THEN "Advance Salary"
                                      WHEN advance_type = "Other Advance" THEN "Advance IOU Adjustment"
                                      END) AS advance_type,
                                      payable_amt,
                                      installment_no,
                                      ...
                                      advance_amt AS total_advance_amt
                                      FROM salary_advance
