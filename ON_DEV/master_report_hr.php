				...
				?>
 				...
 				<?
					...
					?>
 					...
 					<!-- Bhaiya Housing Letters Start From Here -->
 				...
 				<? } elseif ($_POST['report'] == 22) { ?>
 					...
 					<form action="" method="post">
 						...
 						<table>
 							<tr>
 								<h2 align="center"><b>Bhaiya Housing</b></h2>
 								<p style="text-align:center;">
 									<br /><br />
 									<br /><br />
 									<u>Banani, Dhaka-1213</u>
 								</p>
 							<tr>
 							...
 							<p>Subject: Letter of Appointment as ‘<?= $info->PBI_DESIGNATION ?>’ under Bhaiya Housing Ltd</p>
 							...
 							<a style="text-align: justify;">
 								...
 								the management of Bhiaya Housing Ltd is pleased to inform you that you have been
 								selected to fill up the position of <?= $info->PBI_DESIGNATION ?> of <?= $info->PBI_DEPARTMENT ?> department
 								of Bhaiya Housing Ltd under the following terms and conditions.
 							</a>
 							...
 							<ol>
 								...
 								<li>Nature of Job and place of posting: You will be presently posted at <?= $info->PBI_DEPARTMENT ?> Department at Banani office of Bhaiya Housing Ltd.</li>
 								<li>Date of Joining: You are expected to furnish your joining report to Head of Human Resources Department of Bhaiya Housing Ltd, Corporate office, Banani, Dhaka on <?= $info->PBI_DOJ ?> AT the time of joining you shall have to provide below mentioned documents:
 									<ol type="a">
 								...
 								<li>Reporting Authority: You have to report the <?= find_a_field('personnel_basic_info', 'PBI_NAME', 'PBI_ID="' . $info->incharge_id . '"'); ?> of Bhaiya Housing Ltd.</li>
 								<li>Working Days: 06 (Six) day within a week (Saturday- Thursday)</li>
 								<li>Office Time: From 9.30 AM to 6.30 PM (Additional time may have to be spend on exceptional circumstances)</li>
 								...
 								<li>Off-the-Job Engagement: During your employment with Bhaiya Housing Ltd or with any sister concern of the Group, you shall not engage in any other job, business or earning activities.</li>
 								...
 								<li>Secrecy and Confidentiality: During your employment you shall not share any information either verbally or written with any individual or organization outside of Bhaiya Housing Ltd and its affiliates or subsidiaries. The policies, procedures, data or any sort of information/ document relating to the company shall be considered as the exclusive property of Bhaiya Housing Ltd. Any violation of secrecy and confidentiality shall be regarded as major offence and is subject to punitive disciplinary measure.</li>
 							</ol>
 							...
 							<div style="position: relative; margin-top: 150px;">
 								<div style="width: 50%; float: left; text-align: left; margin-left: 0%;">
 									...
 									<p style=" margin-left: 35px;">Bhaiya Housing Ltd</p>
 				...
 				<? } elseif ($_POST['report'] == 23) { ?>
 					...
 					<form action="" method="post">
 						<table>
 							...
 							<a>In response to your application and the subsequent interview you have had with us. We are pleased to make you an offer for the position of ‘<?= $promotion_info->PROMOTION_PRESENT_DESG ?> (<?= $info->PBI_DEPARTMENT ?>)’ in the department of Sales & Marketing at Bhaiya Housing Limited. You will be given a letter of appointment on joining. Details of your salary package is attached as Annex-A.</a>
 					...
 					<form action="" method="post">
 						...
 						<table>
 							...
 							<div>
 								...
 								<p>Thank You,</p>
 								<br>
 								<p>Mahtab Uddin Chowdhury</p>
 								<p> Head of HR &amp; Admin</p>
 								<p> Bhiya Housing Ltd.</p>
 							</div>
 						</table>
 					</form>
 				...
 				<? } elseif ($_POST['report'] == 25) { ?>
 					...
 					<form action="" method="post">
 						<table>
 							...
 							<p>Dear Mr. <?= $info->PBI_NAME ?>,</p>
 							<a>We regret to inform you that your employment with Bhaiya Housing Limited is being terminated with immediate effective from <?= $info->resign_date ?>.</a>
 							...
 							<h4>Regards,</h4>
 							<p>For Bhaiya Housing Limited</p>
 							<p>Mahtab Uddin Chowdhury</p>
 							<p>Head of HR & Admin</p>
 							<p>Bhaiya Housing Ltd.</p>
 				...
 				<? } elseif ($_POST['report'] == 26) { ?>
 					...
 					<form action="" method="post">
 						<table>
 							...
 							<p>Employee ID: <?= $info->PBI_CODE ?></p>
 							<p>is the employee of Bhaiya Housing Limited from <?= $info->PBI_DOJ ?> to <?= $info->resign_date ?>.</p>
 				...
 				<? } elseif ($_POST['report'] == 28) { ?>
					...
					?>
 					...
 					<form action="" method="post">
 						<table>
 							<tr>
 								<h2 align="center"><b>Bhaiya Housing Limited</b></h2>
 								<p style="text-align:center;">
 							...
 							<br>
 							<div>	
 								<a>All employees serving in Bhaiya Housing limited, we do hereby inform you that the office will remain closed on <?= $info->holy_day ?> due to celebrating ‘<?= $info->reason ?>’. It’s our pride to have the global recognition of that day.</a>
