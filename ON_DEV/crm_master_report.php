...
order by a.PBI_ID';
          ...
          ?>
            ...
            <tr>
              ...
              <td><span style="text-align:right; font-weight:bold;"><?php if ($data->held_up_status == '0') {
    ...
    ?>
      ...
      <body>
        ...
        <table width="100%" cellspacing="0" cellpadding="2" border="0">
          ...
          <thead>
            <tr>
              <th style="border:0px;" colspan="7">
                <h3 style="text-align:center; margin-bottom: 50px; font-weight: bold;">All Peoples Information</h3>
              </th>
            </tr>
      ...
      <table width="100%" cellspacing="0" cellpadding="2" border="0">
        <thead>
          ...
          <tr>
            ...
            <th colspan="2">
              <div align="center">Leave Balance</div>
            </th>



            <th colspan="12" align="center">
              <div align="center">List Of Holyday Duty</div>
            </th>
...
where t.pbi_held_up=0 and s.cash_bank="IBBL" and d.DESG_ID=t.pbi_designation and t.mon=' . $_POST['mon'] . ' and t.year=' . $_POST['year'] . ' and t.PBI_ID=a.PBI_ID and t.PBI_ID=s.PBI_ID ' . $con . ' order by (t.consolidated_salary+t.basic_salary) desc';
          ...
          ?>
            ...
            <tr>
              ...
              <td>
                <font color="#FFFFFF">'</font><?= $data->cash ?>
              </td>
      ...
      <table width="100%" cellspacing="0" cellpadding="2" border="0">
        ...
        <thead>
          ...
          <tr>
            ...
            <th rowspan="3">
              <div align="center">Salary Arrear</div>
            </th>



            <th rowspan="3">
              <div align="center">Mobile Limit</div>
            </th>
          ...
          <tr>
            ...
            <th rowspan="2">
              <div align="center">Basic Increment Aggregation</div>
            </th>
            ...
            <th rowspan="2">
              <div align="center">Child Allowance</div>
            </th>



            <th rowspan="2">
              <div align="center">Performance Bonus</div>
            </th>



            <th rowspan="2">
              <div align="center">Resource Bonus</div>
            </th>
          ...
          ?>
            ...
            <tr>
              ...
              <td align="right"><?= ($data->special_allowance > 0) ? $data->special_allowance : '';
                                $totAggregation += $data->special_allowance ?></td>
              ...
              <td align="right"><?= ($data->conveyance_allowance > 0) ? $data->conveyance_allowance : '';
                                $totspecial += $data->conveyance_allowance ?></td>



              <td align="right"><?= ($data->child_allowance > 0) ? $data->child_allowance : '';
                                $totChildAlw += $data->child_allowance ?></td>



              <td align="right"><?= ($data->performance_bonus > 0) ? $data->performance_bonus : '';
                                $totPerBonus += $data->performance_bonus ?></td>
              ...
              <td align="right"><?= ($data->resourse_bonus > 0) ? $data->resourse_bonus : '';
                                $totResourse_bonus += $data->resourse_bonus ?></td>
              ...
              <td align="right"><?= ($data->mobile_allowance > 0) ? $data->mobile_allowance : '';
                                $totMobileAlw += $data->mobile_allowance ?></td>
              ...
              <td align="right"><?= ($data->other_install > 0) ? $data->other_install : '';
                                $totAdvInstall += $data->other_install ?></td>



              <td align="right"><?= ($data->pf_deduction > 0) ? $data->pf_deduction : '';
                                $totPfDeduct += $data->pf_deduction ?></td>
              ...
              <td align="right"><?= ($tot_ded > 0) ? $tot_ded : '';
                                $totOtherDeduct += $tot_ded ?></td>
      ...
      <table width="100%" cellspacing="0" cellpadding="2" border="0">
        <thead>
          ...
          <tr>
            ...
            <th colspan="6">
              <div><?= date('F', mktime(0, 0, 0, $mon, 10)); ?>-<?= $year ?></div>
            </th>
...
order by b.total_salary desc";
          ...
          <table width="100%" cellspacing="0" cellpadding="2" border="0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td align="center" style="text-align:right">Cash Payment:<strong><?= number_format($data->cash_paid, 2);
                                                                                  $n_p_total += $data->total_payable; ?></strong></td>
        ...
        <table width="100%" cellspacing="0" cellpadding="2" border="0">
          ...
          <tbody>
            ...
            if ($_REQUEST['project_id'] != '') {
              $project_con = " and PROJECT_ID='" . $_REQUEST['project_id'] . "'";
            }
      ...
      if ($_REQUEST['project_id'] != '') {
        $lead_type = " and l.project_id='" . $_REQUEST['project_id'] . "' ";
      }



      if ($_REQUEST['lead_status'] != '') {
        $lead_status = " and l.lead_status='" . $_REQUEST['lead_status'] . "' ";
      }



      if ($_REQUEST['group_id'] != '') {
        $group_con = " and g.id='" . $_REQUEST['group_id'] . "' ";
      }



      if ($_REQUEST['lead_type'] != '') {
        $lead_type = " and l.lead_type='" . $_REQUEST['lead_type'] . "' ";
      }
      ...
      if ($_REQUEST['project_id'] != '') {
        $project_con = " and p.PROJECT_ID='" . $_REQUEST['project_id'] . "' ";
      }
        ...
        <table width="90%" border="0" cellpadding="0" cellspacing="0" class="oe_form_group " align="center" style="font-size: 14px;">
          ...
          <tbody>
            ...
            <tr class="oe_form_group_row">
              ...
              <td colspan="5" bgcolor="#00CCFF" class="oe_form_group_cell_label oe_form_group_cell">
                <div align="center"><strong>CUSTOMER INFORMATION </strong></div>
              </td>
            ...
            <tr>
              ...
              <td colspan="5" class="oe_form_group_cell oe_form_group_cell_label" bgcolor="#00CCFF">
                <div align="center"><strong>PARMANENT ADDRESS </strong></div>
              </td>
            ...
            <tr>
              ...
              <td colspan="5" class="oe_form_group_cell oe_form_group_cell_label" bgcolor="#00CCFF">
                <div align="center"><strong>PRESENT ADDRESS </strong></div>
              </td>
            ...
            <tr>
              ...
              <td colspan="5" class="oe_form_group_cell oe_form_group_cell_label" bgcolor="#00CCFF">
                <div align="center"><strong>COMPANY INFORMATION </strong></div>
              </td>
    ...
    elseif ($_REQUEST['report'] == 203) {
      ...
      if ($_POST['PBI_ID'] != '') {
        $contact_con = " and c.entry_by='" . $_POST['PBI_ID'] . "' ";
      }

      if ($_POST['f_date'] != '' && $_POST['t_date'] != '') {
        $service_con = " and c.c_date between '" . $_POST['f_date'] . "' and  '" . $_POST['t_date'] . "' ";
      }
      ...
      if ($_POST['emp_code'] != '') {
        $contact_con = " and b.emp_code='" . $_POST['emp_code'] . "' ";
      }

      if ($_POST['con_type'] != '') {
        $types = " and b.conveyance_type='" . $_POST['con_type'] . "' ";
      }

      if ($_POST['f_date'] != '' && $_POST['t_date'] != '') {
        $service_con = " and b.conveyance_date between '" . $_POST['f_date'] . "' and  '" . $_POST['t_date'] . "' ";
      }
      ...
      ?>
        ...
        <table width="100%" id="expoettable"  cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse; font-size:14px; font-family:'Times New Roman', Times, serif; padding:5px;">
...
where a.PBI_CODE=b.emp_code and b.status!='Pending' " . $project_con . $contact_con . $service_con . $types . $status_con . " order by b.conveyance_date";
            ...
            ?>
              ...
              <tr <? ++$sl;
                ...
                <td align="right"><?= $data->amount;
                                  $amount_tot += $data->amount; ?></td>
            ...
            <tr>
              ...
              <td align="right">
                <strong><?= number_format($amount_tot, 2) ?></strong>
              </td>
              <td colspan="9">&nbsp;</td>
            </tr>
          </tbody>
        ...
        <div style="width:80%; margin:0 auto">
          ...
          <div style="float:left; width:50%; text-align:center; font-size:18px;">-----------------<br>
            Checked By
          </div>
      ...
      if ($_POST['status'] != '') {
        ...
        <table id="expoettable" width="100%" cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse; font-size:14px; font-family:'Times New Roman', Times, serif; padding:5px;">
          <thead>
  ...
  where a.PBI_CODE=b.emp_code and b.status!='Pending' " . $project_con . $contact_con . $service_con . $types . $status_con . " order by b.conveyance_date";
            ...
            ?>
              ...
              <tr <? ++$sl;
                ...
                <!-- <td>
  <? if ($data->attachment != '') { ?><a href="<?= $data->attachment ?>" target="_blank">Attachment</a><? } ?>
</td>-->
              </tr>
      ...
      ?>
        ...
        <table width="100%" cellspacing="0" cellpadding="2" border="0">
          ...
          <tbody>
            ...
            if ($_POST['project_id'] != '') {
              $project_con = " and a.project_id='" . $_POST['project_id'] . "' ";
            }



            if ($_POST['service_id'] != '') {
              $service_con = " and a.service_id='" . $_POST['service_id'] . "' ";
            }



            if ($_POST['dealer_code'] != '') {
              $service_con = " and b.dealer_code='" . $_POST['dealer_code'] . "' ";
            }



            if ($_POST['PBI_ID'] != '') {
              $service_con = " and a.PBI_ID='" . $_POST['PBI_ID'] . "' ";
            }



            if ($_POST['f_date'] != '' && $_POST['t_date'] != '') {
              $date_con = " and a.c_date between '" . $_POST['f_date'] . "' and '" . $_POST['t_date'] . "' ";
            }
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  ...
                  <input name="sim#<?= $datas[0] ?>" type="text" id="sim#<?= $datas[0] ?>" value="<?= $datas[12] ?>" />
                </td>
