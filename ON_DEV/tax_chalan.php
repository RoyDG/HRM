...
<div class="oe_form_sheetbg">
        ...
        <div class="oe_form_sheet"> <!--oe_form_sheet_width-->
		  ...
		  a.tax_chalan_no as Tax_Chalan_No,
		  DATE_FORMAT(a.chalan_start_date , "%d-%b-%Y") as Tax_Chalan_Date,
		  CONCAT(a.s_year, "-" , a.e_year) AS TAX_Year,
		  CONCAT(a.assesment_s_year, "-" , a.assesment_e_year) AS Assesment_Year,
		  a.chalan_amt as Chalan_Amount
		  
		  from '.$table.' a
		  
		  where a.assesment_s_year="'.date("Y").'" and a.PBI_ID='.$_SESSION['employee_selected'];
