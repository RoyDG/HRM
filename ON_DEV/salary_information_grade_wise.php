                    ...
                    <table  border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-sm">
                      <tbody>
                        ...
                        <tr class="oe_form_group_row">
                          ...
                          <td  class="oe_form_group_cell"><select name="grade" id="grade" onchange="getData2('grade_ajax.php', 'grade_year_id', document.getElementById('grade').value)" >
                              <option></option>
                          ...
                          <td  class="oe_form_group_cell"><span id="grade_year_id">
                        ...
                        <tr class="oe_form_group_row">
                          ...
                          <td  class="oe_form_group_cell"><input name="cash" type="text" id="cash" value="<? 
						  if($cash>0) echo $cash; else{ echo find_a_field('personnel_basic_info','PBI_BANK_ACC_NO','PBI_ID='.$_SESSION['employee_selected']);}?>" class="form-control" /></td>
                          <td class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;&nbsp;Salary Given by :</span></td>
                          <td class="oe_form_group_cell"><select name="cash_bank" id="paymentType" onchange="calculateAmount()"  class="form-control">
                              <option></option>
                        ...
                        <tr class="oe_form_group_row">
                          ...
                          <td bgcolor="#FFFFFF" class="oe_form_group_cell"><input name="cash_amt" type="text" id="cash_amt" onkeyup="calculateAmount()"  value="<?=$cash_amt?>" /></td>
                          <td bgcolor="#FFFFFF" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Bank Paid</span></td>
                          <td bgcolor="#FFFFFF" class="oe_form_group_cell"><input name="bank_amt" type="text" id="bank_amt"   value="<?=$bank_amt?>" readonly /></td>
                        </tr>
                        <tr class="oe_form_group_row">
...
function calculateAmount() {
  var grossSalary = ((document.getElementById('gross_salary').value)*1);
...
/*function calculateCashBankAmounts() {
...
/*function toggleInput(){
  ...
  var dropdown = document.getElementById("cash_bank");
  var cash_input = document.getElementById("cash_amt");
  var bank_input = document.getElementById("bank_amt");
  
  if (dropdown.value === "Cash") {
      bank_input.setAttribute("readonly", "readonly");
  } else if(dropdown.value === "Bank") {
      cash_input.setAttribute("readonly", "readonly");
  }else{
     bank_input.readOnly = false;
	 cash_input.readOnly = false;
  }
