...
$msggg= "<h2 style='color:#FF0000'>Your Casual Leave (CL) already completed <br> (আপনার Casual Leave (CL)  সম্পূর্ণ হয়েছে) </h2>";
...
$msggg="<h2 style='color:#FF0000'>Casual Leave cannot be joined with Annual Leave(AL) <br> Casual Leave(CL) এবং Annual Leave(AL) একসাথে নেওয়া যাবে না।
...
$msggg="<h2 style='color:#FF0000'>Sick Leave(SL) cannot be joined with Casual Leave(CL) <br> Sick Leave(SL) এবং Casual Leave(CL) একসাথে নেওয়া যাবে না।
...
$msggg="<h2 style='color:#FF0000'>Casual Leave (CL) cannot be joined with Paternity Leave <br> Casual Leave (CL) এবং Paternity Leave একসাথে নেওয়া যাবে না।
...
<br> (আপনার Sick Leave (SL) সম্পূর্ণ হয়েছে)</h2>";
...
$msggg= "<h2 style='color:#FF0000'>Your Annual Leave (AL) already completed
 ...
 <br> (আপনার Annual Leave (AL) সম্পূর্ণ হয়েছে)</h2>";
...
$msggg="<h2 style='color:#FF0000'>Annual Leave(AL) cannot be joined with Casual Leave(CL)  <br> Annual Leave(AL) এবং  Casual Leave(CL) একসাথে নেওয়া যাবে না।
...
$msggg="<h2 style='color:#FF0000'>Annual Leave(AL) cannot be joined with Sick Leave(SL) <br> Sick Leave(SL) এবং Annual Leave(AL) একসাথে নেওয়া যাবে না।
...
$msggg="<h2 style='color:#FF0000'>Annual Leave(AL) cannot be joined with Paternity Leave <br> Annual Leave(AL) এবং Paternity Leave একসাথে নেওয়া যাবে না।
...
$msggg="<h2 style='color:#FF0000'>Annual Leave(AL) cannot be joined with Annual Leave(AL) <br> Annual Leave(AL) এবং Annual Leave(AL) একসাথে নেওয়া যাবে না।
...
$msggg="<h2 style='color:#FF0000'>Marriage Leave cannot be joined with Casual Leave <br> Marriage Leave এবং Casual Leave(CL) একসাথে নেওয়া যাবে না।
...
$msggg="<h2 style='color:#FF0000'>Marriage Leave cannot be joined with Annual Leave(AL) <br> Marriage Leave এবং Annual Leave(AL) একসাথে নেওয়া যাবে না।
...
$msggg= "<h2 style='color:#FF0000'>Your Marriage Leave already completed
 ...
 <br> (আপনার Marriage Leave সম্পূর্ণ হয়েছে)</h2>";
...
$msggg="<h2 style='color:#FF0000'>Paternity Leave cannot be joined with Casual Leave <br> Paternity Leave এবং Casual Leave(CL) একসাথে নেওয়া যাবে না।
...
$msggg="<h2 style='color:#FF0000'>Paternity Leave  cannot be joined with Annual Leave(AL) <br> Paternity Leave  এবং Annual Leave(AL) একসাথে নেওয়া যাবে না।
...
$msggg= "<h2 style='color:#FF0000'>Your Paternity Leave already completed
 ...
 <br> (আপনার Paternity Leave সম্পূর্ণ হয়েছে)</h2>";
...
<br> (শুধু মাত্র স্থায়ী কর্মী/কর্মকর্তা হজ্জ এর ছুটি উপভোগ করতে পারবেন ) </h2>";
...
$msggg= "<h2 style='color:#FF0000'>Your Hajj Leave Leave already completed
 ...
 <br> (আপনার Hajj Leave সম্পূর্ণ হয়েছে)</h2>";
...
$msggg= "<h2 style='color:#FF0000'>Your Maternity Leave Leave already completed
 ...
 <br> (আপনার Maternity Leave সম্পূর্ণ হয়েছে)</h2>";
...
$str ="<span style='font-weight:bold; font-size:16px;'>Your requested Leave Granted</span><br>";
...
<td width="5%"><div align="center" style="font-weight:bold; background:#66CDAA;">ID</div></td>
...
$ss = "select l.id as leave_id,p.PBI_ID,p.PBI_CODE,p.PBI_NAME, desg.DESG_DESC,(select PBI_NAME from personnel_basic_info where PBI_ID=l.leave_responsibility_name) as duties_carried_by, dept.DEPT_DESC, (select PROJECT_DESC from project where PROJECT_ID=p.JOB_LOCATION) as project, l.s_date,l.e_date, l.total_days, t.leave_type_name 
from personnel_basic_info p, designation desg, department dept, hrm_leave_info l,hrm_leave_type t where 1 and l.s_date='".$_REQUEST['s_date']."' and l.e_date='".$_REQUEST['e_date']."'  and l.PBI_ID=p.PBI_ID and p.PBI_DESIGNATION=desg.DESG_ID and p.PBI_DEPARTMENT=dept.DEPT_ID and l.type=t.id and l.PBI_ID='".$imp_info->PBI_ID."' ";
              ...
              <div class="">
                ...
                <div class="oe_form_sheetbg">
                  ...
                  <div class="oe_form_sheet oe_form_sheet_width"> <span style=" text-align:center; font-size:12px;" ><?php echo $msggg; ?></span>
                    ...
                    <table class="oe_form_group " border="1" cellpadding="0" cellspacing="0">
