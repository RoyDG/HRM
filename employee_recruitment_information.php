...
<div style="font-weight:bold; font-size:16px; background-color:#1C3092; z-index: 0!important; text-transform:uppercase; color:#fff" class="card-header">
...
<label class="label" for="grace_type"> Assigned Res :</label>
...
<a href="../../../assets/support/upload_view.php?name=<?=$row->PBI_PICTURE_ATT_PATH?>&folder=hrm_emp_pic" target="_blank" download>

<img src="../../../assets/support/upload_view.php?name=<?=$row->PBI_PICTURE_ATT_PATH?>&folder=hrm_emp_pic" width="120" height="152" /></a>
...
<? if($row->PBI_NID_ATT_PATH>0){  ?>



<a href="../../../assets/support/upload_view.php?name=<?=$row->PBI_NID_ATT_PATH?>&folder=hrm_nid_pic" target="_blank" download>

<img src="../../../assets/support/upload_view.php?name=<?=$row->PBI_NID_ATT_PATH?>&folder=hrm_nid_pic" width="120" height="152"/></a>
...
<div class="col-md-3 form-group">
	...
	<a href="<?=$tin_link?>" target="_blank" download><img src="<?=$tin_link?>" width="120" height="152"/></a>
