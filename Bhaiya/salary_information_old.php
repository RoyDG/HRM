...
<script type="text/javascript">
    function DoNav(lk) {
        ...
        return GB_show('ggg', '../pages/<?= $root ?>/
					   <?= $input_page ?>?<?= $unique ?>=' + lk, 600, 940)
                    ...
                    <div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">	
                                ...
                                <input name="gross_salary" type="text" id="gross-salary" class="form-control" oninput="calculateSalary(),pf_cal()" value="<?= $gross_salary ?>" />								
                            </div>
                    ...
                    <div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                               ...
                               <input name="pf" type="text" id="pf" value="<?=$pf?>" oninput="pf_cal()" class="form-control"/>
	...
	function calculateAmount() {
	  ...
	  if (paymentType === "Cash") {
		...
		bankAmount.value = grossSalary;
			...
			var bankAmt = grossSalary - cashAmt; 
...
<script>
 ...
 function pf_cal(){
 var grossSalarye = ((document.getElementById("basic-salary").value)*1);
 

  var mcpf = (grossSalarye*2)/100;

  var ecpf = (grossSalarye*5)/100;
