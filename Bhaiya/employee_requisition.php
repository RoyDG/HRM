...
<div class="oe_form_sheetbg">
        ...
        <div class="oe_form_sheet">
          ...
          <? 	 $res="select e.REQUISITION_ID, e.REMARKS,(select DESG_SHORT_NAME from designation where DESG_ID=e.DESIGNATION) as DESIGNATION,(select DEPT_SHORT_NAME from department where DEPT_ID=e.DEPARTMENT) as DEPARTMENT,(select PROJECT_DESC from project where PROJECT_ID=e.JOB_LOCATION ) as JOB_LOCATION, (select PBI_NAME from personnel_basic_info where PBI_ID=e.REQ_BY) as REQ_BY from employee_requisition e";
